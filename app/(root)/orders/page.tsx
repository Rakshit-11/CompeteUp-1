        ...
        <table className="w-full border-collapse border-t">
          <thead>
            <tr className="p-medium-14 border-b text-grey-500">
              ...
              <th className="min-w-[200px] py-3 text-left">Email</th>
              <th className="min-w-[100px] py-3 text-left">Created</th>
              <th className="min-w-[100px] py-3 text-right">Amount</th>
              <th className="min-w-[200px] py-3 text-left">College Name</th>
              <th className="min-w-[150px] py-3 text-left">Graduation Start Year</th>
              <th className="min-w-[150px] py-3 text-left">Graduation End Year</th>
              <th className="min-w-[150px] py-3 text-left">Phone Number</th>
              <th className="min-w-[100px] py-3 text-left">Gender</th>
              <th className="min-w-[150px] py-3 text-left">Stream</th>
              <th className="min-w-[150px] py-3 text-left">Specialization</th>
            </tr>
          </thead>
          <tbody>
                ...
                {orders &&
                  orders.map((row: IOrderItem) => (
                    ...
                    >
                      ...
                      <td className="min-w-[200px] py-4">{row.email}</td>
                      ...
                      {/* Metadata Fields */}
                      <td className="min-w-[200px] py-4">{row.metadata?.collegeName || 'N/A'}</td>
                      <td className="min-w-[150px] py-4">{row.metadata?.graduationStartYear || 'N/A'}</td>
